...
angular.module('myApp.directives')
    .directive('cmMultipleTargetAnalysisBis', [function () {
        return {
            restrict: 'E',
            replace: true,
            template: '<div class="multipleTargetAnalysisBisDirective"></div>',
            link: function (scope) {

                // Height and width of the SVGs
                var svgHeight = 120, svgWidth = 50;

                var vis = d3.selectAll('.multipleTargetAnalysisBisDirective');
                        ...
                        .each(function (d, i) {
                            ...
                            if (i === algoIndex) {
                                ...
                                d3.select(this).append('rect')
                                    .attr("x", 0)
                                    .attr("y", function(){
                                        return 120 - scope.model.multipleAnalysisData[algoIndex].data[targetIndex].precision*svgHeight;
                                    })
                                    .attr("width", '40px')
