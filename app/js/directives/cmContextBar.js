        ...
        link: function (scope, element) {
            ...
            scope.$watch('model.queueData', function (newValue) {
                if (newValue !== undefined && newValue.fragment !== undefined) {
                    ...
                    updateMarker();
                    if (scope.model.queueData.fragment.context !== undefined && scope.model.queueData.fragment.context.id_medium !== undefined && scope.model.queueData.fragment.context.id_medium !== "" && scope.model.queueData.fragment.context._id !== undefined && scope.model.queueData.fragment.context._id !== "") {
